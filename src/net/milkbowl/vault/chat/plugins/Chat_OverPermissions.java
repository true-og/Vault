...
public class Chat_OverPermissions extends Chat {
    ...
    public Chat_OverPermissions(Plugin plugin, Permission perms) {
        ...
        if (overPerms == null) {
            ...
            if (p != null) {
                ...
                plugin.getLogger()
                        .info(String.format("[%s][Chat] %s hooked.", new Object[]
    ...
    public class PermissionServerListener implements Listener {
        ...
        public void onPluginEnable(PluginEnableEvent event) {
            ...
            if (chat.overPerms == null) {
                ...
                if (chat != null) {
                    ...
                    plugin.getLogger()
                            .info(String.format("[%s][Chat] %s hooked.", new Object[]
                            { plugin.getDescription().getName(), getName() }));
        ...
        public void onPluginDisable(PluginDisableEvent event) {
            ...
            if ((chat.overPerms != null) && (event.getPlugin().getDescription().getName().equals("OverPermissions"))) {

                chat.overPerms = null;
                plugin.getLogger()
                        .info(String.format("[%s][Chat] %s un-hooked.", new Object[]
                        { plugin.getDescription().getName(), getName() }));
