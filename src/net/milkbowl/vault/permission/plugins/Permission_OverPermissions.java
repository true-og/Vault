    ...
    public Permission_OverPermissions(Plugin plugin) {
        ...
        if (overPerms == null) {
            ...
            if ((perms != null) && (perms.isEnabled())) {
                ...
                log.info(
                        String.format("[%s][Permission] %s hooked.", new Object[]
                        { plugin.getDescription().getName(), "OverPermissions" }));
    ...
    public class PermissionServerListener implements Listener {
        ...
        public void onPluginEnable(PluginEnableEvent event) {
            ...
            if (permission.overPerms == null) {
                ...
                Plugin perms = Permission_OverPermissions.this.plugin.getServer().getPluginManager()
                        .getPlugin("OverPermissions");
                if (perms != null) {

                    permission.overPerms = ((OverPermissions) perms);
                    Permission_OverPermissions.log
                            .info(String.format("[%s][Permission] %s hooked.", new Object[]
                            { Permission_OverPermissions.this.plugin.getDescription().getName(), "OverPermissions" }));
        ...
        public void onPluginDisable(PluginDisableEvent event) {
                    ...
                    && (event.getPlugin().getDescription().getName().equals("OverPermissions")))
            {
                ...
                Permission_OverPermissions.log
                        .info(String.format("[%s][Permission] %s un-hooked.", new Object[]
                        { Permission_OverPermissions.this.plugin.getDescription().getName(), "OverPermissions" }));
