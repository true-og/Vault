...
public class Permission_bPermissions2 extends Permission {
    ...
    public boolean playerAdd(String world, String player, String permission) {
        ...
        ApiLayer.addPermission(world, CalculableType.USER, player,
                de.bananaco.bpermissions.api.Permission.loadFromString(permission));
        return true;
    ...
    public boolean groupAdd(String world, String group, String permission) {
        ...
        ApiLayer.addPermission(world, CalculableType.GROUP, group,
                de.bananaco.bpermissions.api.Permission.loadFromString(permission));
        return true;
